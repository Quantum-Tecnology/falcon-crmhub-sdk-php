 ...
 *
 * Na maioria das vezes é permissão da chave: ela foi criada sem `messages:send`, e
 * `getAbility()` diz qual permissão faltou. Pode ser também o plano do dono da
 * conta sem integrações. Nos dois casos a solução é no painel do Falcon Vendas —
...
class ForbiddenException extends FalconException
{
    ...
    /** A permissão que faltou (ex.: `messages:send`), quando o motivo foi esse. */
