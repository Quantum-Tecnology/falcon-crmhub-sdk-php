...
class QuotaExceededException extends FalconException
{
    ...
    /**
     * QUOTA_EXCEEDED | PLAN_BLOCKED | SUBSCRIPTION_INACTIVE.
     *
     * A distinção importa: cota estourada resolve sozinha na virada do mês,
     * plano bloqueado exige upgrade, e assinatura inativa exige pagamento.
     */
